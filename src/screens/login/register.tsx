            ...
            <View style={stylesLogin.contect}>
                ...
                <View>
                    ...
                    <Input
                        ...
                        marginTop={5}
                        keyboardType="default"
                        onChangeText={(value) => setValues({ ...values, passwordConfirmation: value })}
                        value={values.passwordConfirmation}
                        InputRightElement={
                            <TouchableOpacity onPress={() => setShowConfirm(!showConfirm)}>
                                <Icon as={<Icons name={showConfirm ? 'visibility' : 'visibility-off'} />} size={5} mr="2" color="white" />
                            </TouchableOpacity>} placeholder="Confirmar Contraseña" />
                </View>
                <View>
                    <TouchableOpacity
